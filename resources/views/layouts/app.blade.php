...
<body class="hold-transition sky-blue layout-top-nav">
	<div class="wrapper">
  		<header class="main-header">
    		<nav class="navbar navbar-static-top">
      			<div class="container">
					...
					<a href="{{ url('/') }}" class="navbar-brand"><img src="{{ asset('public/img/logo.png')}}" alt="DoctorKoi logo" height="35" width="130"></a>
